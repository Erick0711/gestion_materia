...
<body>
    ...
    <form class="border border-dark p-5 bg-dark w-50" method="POST" action="./create.php" autocomplete="off">
        <div class="mb-3">
        ...
        <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        <select name="materia[]" id="materia" class="form-select" multiple>
